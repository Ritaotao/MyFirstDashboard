...
def insight(request):
    ...
    # membership percentage computation
    red3_perc = (red3_1+red3_2+red3_3+red3_4)/round(pop_tot,1)
    white3_perc = (white3_1+white3_2+white3_3+white3_4)/round(pop_tot,1)
    red6_perc = (red6_1+red6_2)/round(pop_tot,1)
    white6_perc = (white6_1+white6_2)/round(pop_tot,1)
    variety3_perc = (variety3_1+variety3_2+variety3_3+variety3_4)/round(pop_tot,1)
    variety6_perc = (variety6_1+variety6_2)/round(pop_tot,1)
    
    # weighted avg bottles per pack
    pop_3pack = red3_1+red3_2+red3_3+red3_4+white3_1+white3_2+white3_3+white3_4+variety3_1+variety3_2+variety3_3+variety3_4
    ...
    nod.red3_perc = red3_perc
    nod.white3_perc = white3_perc
    nod.red6_perc = red6_perc
    nod.white6_perc = white6_perc
    nod.variety3_perc = variety3_perc
    nod.variety6_perc = variety6_perc
    nod.save()
    if reds_each >= 0 & whites_each>=0:
        message1 = 'Quick View: Red Cases: %i; White Cases: %i. To see details, click <Details>.' %(reds_each, whites_each)
    else:
...
def detail(request):
    ...
    round_red3_perc = round(nod.red3_perc*100, 2)
    round_white3_perc = round(nod.white3_perc*100, 2)
    round_red6_perc = round(nod.red6_perc*100, 2)
    round_white6_perc = round(nod.white6_perc*100, 2)
    round_variety3_perc = round(nod.variety3_perc*100, 2)
    round_variety6_perc = round(nod.variety6_perc*100, 2)
    real_red = result.reds_each*36
    real_white = result.whites_each*36
    real_tot = real_red+real_white
    min_red = int(ceil(((nod.red3_perc+nod.variety6_perc)*3+nod.red6_perc*6)*result.tot_pack/36))
    min_white = int(ceil(((nod.white3_perc+nod.variety6_perc)*3+nod.white6_perc*6)*result.tot_pack/36))
    ...
    context = {
        ...
        "red3_perc": round_red3_perc,
        "white3_perc": round_white3_perc,
        "red6_perc": round_red6_perc,
        "white6_perc": round_white6_perc,
        "variety3_perc": round_variety3_perc,
        "variety6_perc": round_variety6_perc,
